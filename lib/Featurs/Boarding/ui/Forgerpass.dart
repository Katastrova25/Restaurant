      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              maxLines: 3,
              "Please enter your  phone number or email address to receive a link to create a new password via email . confirmation code will be sent to you.",
              style: TextStyle(
                  color: Colors.black,
          ...
          Center(
            ...
            sign: "Confirm ",
            onpressed: () {
              Navigator.pushNamed(context, AppRoutes.Confirme);
            },
          )),
        ],
      ),
